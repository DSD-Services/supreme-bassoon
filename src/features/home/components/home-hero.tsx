...
export default function HomeHero() {
  return (
    <section className="flex flex-col-reverse items-center justify-center gap-4 py-8 md:flex-row md:gap-10 md:py-10 lg:gap-20 lg:py-12 xl:py-16">
      <div className="text-primary flex flex-col justify-center px-2 text-center text-3xl font-semibold md:text-left md:text-4xl lg:text-5xl">
        <h1>
