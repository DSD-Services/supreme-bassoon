  ...
  return (
    <>
      ...
      <div className='col-span-6 mt-2 pb-2'>
        <div className='flex justify-center'>
          <button
            className='bg-blue-700 text-white flex gap-2 items-center w-36 px-2 py-1 text-sm rounded-lg font-semibold shadow-lg cursor-pointer hover:scale-105 transition hover:bg-blue-800'
